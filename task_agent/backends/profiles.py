...
from ..profile import TaskAgentProfile, register_profile


def _build_redmine_profile(config: Any) -> TaskAgentProfile:
    ...
    task_config = config.get_flow_config("task_agent")
