"""Tests for core.commit_format and task_agent.committer modules."""
...
from task_agent.core.commit_format import CommitFormat, _clear_cache, _parse, load_commit_format
...
# ---------------------------------------------------------------------------
# Tests for task_agent.committer.build_commit_message
# ---------------------------------------------------------------------------
...
def _build(subject, task_type="code_change", issue_id=1, summary="done"):
    ...
    with patch(
        "task_agent.committer.load_commit_format", return_value=_MOCK_FMT
    ):
        from task_agent.committer import build_commit_message
...
class TestBuildCommitMessage:
    ...
    def test_body_contains_automated_by(self):
        ...
        assert "Automated-By: task-agent" in msg
