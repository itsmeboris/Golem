...
class TestCopyMcpJson:
    ...
    def test_empty_list_skips_copy(self, tmp_path):
        ...
        created: list[Path] = []
        with patch("task_agent.core.cli_wrapper._PROJECT_MCP_JSON", source):
...
class TestProjectRootSandbox:
    ...
    def test_cwd_at_project_root_gets_temp_sandbox(self, tmp_path):
        ...
        with patch("task_agent.core.cli_wrapper._PROJECT_ROOT", tmp_path):
            config = CLIConfig(
    ...
    def test_explicit_worktree_still_used_directly(self, tmp_path):
        ...
        with patch("task_agent.core.cli_wrapper._PROJECT_ROOT", tmp_path / "project"):
            config = CLIConfig(
