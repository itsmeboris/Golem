"""Tests for task_agent.worktree_manager."""
...
from task_agent.worktree_manager import (
    _current_branch,
    _run_git,
    cleanup_worktree,
    create_worktree,
...
class TestCreateWorktree:
    ...
    def test_raises_on_failure(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("task_agent.worktree_manager._run_git", mock_run_git)
...
class TestNewConfigFields:
    def test_defaults(self):
        from task_agent.core.config import TaskAgentFlowConfig
    ...
    def test_parse_from_yaml(self):
        from task_agent.core.config import _parse_task_agent_config
