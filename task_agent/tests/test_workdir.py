"""Tests for agents/task_agent/workdir.py — work-dir resolution logic."""

# pylint: disable=missing-class-docstring,missing-function-docstring

from task_agent.workdir import (
...
class TestParseSubjectWorkdir:
    ...
    def test_matching_tag_returns_path(self):
        result = _parse_subject_workdir("[MYPROJECT] fix bug", {"MYPROJECT": "/some/path"})
...
class TestResolveWorkDir:
    ...
    def test_full_priority_chain(self, tmp_path):
        ...
        assert resolve_work_dir("[MYPROJECT] t", "", work_dirs, default, root) == cs_path
