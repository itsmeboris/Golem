...
- [x] REL-010: **GitHub `_gh()` wrapper missing subprocess timeout** — added timeout=60 with TimeoutExpired handling (GH #109, 2026-03-29)
- [x] REL-011: **graceful_stop doesn't await cancelled tasks** — added asyncio.gather(*pending, return_exceptions=True) after cancel (GH #113, 2026-03-29)
...
- [x] REL-011: **graceful_stop doesn't await cancelled tasks** — added asyncio.gather after cancel (GH #110, 2026-03-29)
