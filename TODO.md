...
- [x] UX-008: **Keyboard shortcuts and mobile layout** — keydown handler (Escape, arrows, Ctrl+K, 1-5); @media queries at 1024px/768px with 44px touch targets (GH #121, 2026-03-29)
- [x] UX-008b: **Missing Enter key handler and wrong breakpoint** — added Enter key to open selected task; fixed breakpoint from 600px to 768px (GH #148, 2026-03-30)
