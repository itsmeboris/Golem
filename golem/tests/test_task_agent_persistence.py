    ...
    def test_full_roundtrip_all_fields(self, tmp_path):
        ...
        sessions = {
            1: TaskSession(
                ...
                trace_file="traces/golem/test.jsonl",
                total_cost_usd=1.50,
            ),
            2: TaskSession(
                parent_issue_id=2,
        ...
        assert s1.trace_file == "traces/golem/test.jsonl"
...
class TestRedmineStatusVerification:
    ...
    def test_successful_status_update(self, monkeypatch):
        ...
        monkeypatch.setattr("golem.backends.redmine._request_with_retry", mock_retry)
        monkeypatch.setattr(
            "golem.backends.redmine.get_redmine_headers",
